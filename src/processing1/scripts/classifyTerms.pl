...
#print "$infile\: In total $termsum terms and $termmatch matches with $nummatchterms distinct terms.\n";
...
#print "$infile\: In total $termsum terms and $termmatch matches with $nummatchterms distinct terms and $unmatched unmatched terms.\n";
